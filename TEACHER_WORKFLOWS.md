# 📚 TEACHER WORKFLOWS - E-LEARNING PLATFORM
...
9.6. Workflow kích hoạt thu thập analytics thủ công (manual)
...
- Mỗi workflow sẽ được mô tả chi tiết ở các phần tiếp theo
- Bao gồm các API endpoint được gọi và collections trong database được sử dụng
- Workflow được chia làm 3 phần để dễ theo dõi
